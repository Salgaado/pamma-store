...
const dataMock = {
  header: {
    ...
    flash: {
      enabled: true,
      message: "Apreveite nossas ofertas com Frete grátis a partir de R$200*",
      tooltip_message: "Flash action custom message",
      trigger_message: "Ver produtos",
      action: {
        message: "ver produtos",
        href: ''
      }
    },
    bannerStyles: '',
  ...
  footer: {
    ...
    i18n: {
      ...
      powered_by: 'Powered by Ecom Labs'
    },
    showContact: true,
    showEmail: true,
    showAddress: false,
    showPhone: true,
    showBusinessData: true, // just BR, only if data is present and user wants to show it
